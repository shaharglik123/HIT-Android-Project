 ...
 * Use the {@link FPSFragment#newInstance} factory method to
...
public class FPSFragment extends Fragment {
     ...
     * @return A new instance of fragment FPSFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FPSFragment newInstance(String param1, String param2) {
        FPSFragment fragment = new FPSFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_f_p_s, container, false);

        LinearLayout right_linearLayout = view.findViewById(R.id.fps_right_linear_layout);
        LinearLayout left_linearLayout = view.findViewById(R.id.fps_left_linear_layout);

        UserActivity userActivity = (UserActivity) getActivity();
        userActivity.setI(0);
        for (GameProduct gameProduct : userActivity.getDataBaseGames()) {
            if (gameProduct.getGenre().equals("fps")) {
                        ...
                        public void onClick(View view) {
                            ...
                            for (GameProduct gameProduct : userActivity.getDataBaseGames()) {
                                if (gameProduct.getName().equals(view.getContentDescription())) {
                                    ...
                                    Navigation.findNavController(view).navigate(R.id.action_FPSFragment_to_currentGameFragment, bundle);
                                }
                            }
                        }
                    });
