...
public class SportsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LinearLayout right_linearLayout = view.findViewById(R.id.sports_right_linear_layout);
        LinearLayout left_linearLayout = view.findViewById(R.id.sports_left_linear_layout);

        UserActivity userActivity = (UserActivity) getActivity();
        userActivity.setI(0);
        for (GameProduct gameProduct : userActivity.getDataBaseGames()) {
            if (gameProduct.getGenre().equals("sports")) {
                        ...
                        public void onClick(View view) {
                            ...
                            for (GameProduct gameProduct : userActivity.getDataBaseGames()) {
                                if (gameProduct.getName().equals(view.getContentDescription())) {
                                    ...
                                    Navigation.findNavController(view).navigate(R.id.action_sportsFragment_to_currentGameFragment, bundle);
                                }
                            }
                        }
                    });
